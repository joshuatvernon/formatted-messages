 ...
 *
 * @param string message - an unformatted string message to colourise
 */
 ...
 *
 * @param string message - an unformatted string message to format
 * @param string placeholder - a placeholder to look for and replace in the message
 * @param any value - a value to replace the placeholder with in the message
 *
 ...
 * @param string message - an unformatted string message to format
 * @param string placeholder - a placeholder to look for and replace in the message
 * @param array values - an array of values to replace the placeholder with in the message
 * @param string separator - a separator to separate the values when adding them to the message
 *
 ...
 *
 * @param Object unformattedMessage - an unformatted message to format
 * @param Object options - an object containing properties to replace in the message
 *
 ...
 *
 * @param string message - a string message to be printed to the console
 */
